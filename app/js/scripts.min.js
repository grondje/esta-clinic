...
$(function() {
	...
	const docPopupsInit = () => {
		...
		const docPopupGenerateMarkup = (markupInfo) => {
			const { docName: name, docImage: imagePath, docProf: prof, docDescription: desc} = markupInfo;
			console.log(name, imagePath, prof, desc);
			return `
		...
		const docPopupGenerateSettings = (popupTriggerNode) => {
			...
			const docInformation = { docName, docImage, docProf, docDescription };
	...
	const navigationInit = () => {
		const navigationLinks = document.querySelectorAll('.navigation-list__link');
		...
		const onNavigationLinkClick = (e) => {
			...
			e.preventDefault();
			_removeClassFromAllNodes(navigationLinks);
